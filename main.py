"""
Ids Ml System
Machine learning Intrusion Detection System for network monitoring
...
def main():
    print("=" * 65)
    print(f"  Ids Ml System")
    print("=" * 65)
    print(f"  Machine learning Intrusion Detection System for network monitoring")
    print()
